...
import { Building2, FileText, LogOut, Save, ChevronDown, ChevronUp, Camera, X } from 'lucide-react'
  ...
  return (
    <AppShell>
      ...
      <PageContainer>
        ...
        {/* Business details */}
        <div className="mb-4">
          <h2 className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-3">Business</h2>
          <Card>
            <button
            ...
            >
              ...
              <div className="flex-1 text-left">
                <p className="text-sm font-medium text-slate-800">Business details</p>
            ...
            {openSection === 'business' && (
              <div className="px-4 pb-4 space-y-3 border-t border-slate-100 pt-4">
                ...
                {/* Logo upload */}
                <div>
                  <label className="block text-xs font-medium text-slate-500 mb-2">Business logo</label>
                ...
                <div>
                  <label className="block text-xs font-medium text-slate-500 mb-1.5">Business name <span className="text-red-400">*</span></label>
                ...
                <div>
                  <label className="block text-xs font-medium text-slate-500 mb-1.5">HST number</label>
        ...
        {/* Invoice settings */}
        <div className="mb-4">
          <h2 className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-3">Invoices</h2>
          <Card>
            <button
              className="w-full flex items-center gap-3 px-4 py-3.5 hover:bg-slate-50 transition-colors"
            ...
            >
              ...
              <div className="flex-1 text-left">
                <p className="text-sm font-medium text-slate-800">Invoice defaults</p>
            ...
            {openSection === 'invoice' && (
              <div className="px-4 pb-4 space-y-3 border-t border-slate-100 pt-4">
                <div>
                  <label className="block text-xs font-medium text-slate-500 mb-1.5">Invoice prefix</label>
                ...
                <div>
                  <label className="block text-xs font-medium text-slate-500 mb-1.5">Default invoice note</label>
                  <textarea
