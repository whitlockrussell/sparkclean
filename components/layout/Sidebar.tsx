...
export function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex flex-col w-56 min-h-screen bg-white border-r border-slate-200 fixed left-0 top-0 z-30">
      ...
      <nav className="flex-1 px-3 py-4 space-y-0.5">
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              <Icon
                className={`w-[18px] h-[18px] flex-shrink-0 ${active ? 'text-teal-600' : 'text-slate-400'}`}
      ...
      <div className="px-4 py-4 border-t border-slate-100">
        <div className="flex items-center gap-2.5">
          ...
          <div className="min-w-0">
            <p className="text-xs font-medium text-slate-700 truncate">My Business</p>
